#!/usr/bin/env python3
"""Launch five color-scheme visual audit workers (cursor-driven via MCP in chat)."""
...
WORKER = Path(__file__).resolve().parent / "color_scheme_cursor_worker.py"
PYTHON = ROOT / ".venv" / "bin" / "python3"
DEFAULT_SLICES = (0, 1, 2, 3, 4)
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Comma-separated slice ids 0–4 (default: 0,1,2,3,4)",
    )
    ...
    summary = {
        "mode": "color_scheme_cursor_slices",
        "slices": slice_ids,
        ...
        "runs": [
            {
                ...
                "schemes": (r.get("result") or {}).get("schemes"),
    ...
    print(out)
    default_out = ROOT / "qa_agent" / "runs" / "parallel_color_scheme_summary.json"
